...
$result=pg_prepare($dbconn,"normalwerte",'select * from wissenstalente.talentwert where ID = $1');
...
$result=pg_prepare($dbconn,"mod",'select * from wissenstalent.modifikation where ID = $1');
