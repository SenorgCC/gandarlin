...
$result=pg_prepare($dbconn,"normalwerte",'select * from spezialtalente.talentwert where ID = $1');
...
$result=pg_prepare($dbconn,"mod",'select * from spezialtalente.modifikation where ID = $1');
