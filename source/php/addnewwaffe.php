...
$stmt2="insert into spieler.waffen_kampftalent values($1,$2,$3,0,0)";
$data2=array($WP_ID,$SP_ID,$WAFRT);
...
$result=pg_prepare($dbconn,"spielerwaffenkt",$stmt3);
$result=pg_execute($dbconn,"spielerwaffenkt",$data3);
