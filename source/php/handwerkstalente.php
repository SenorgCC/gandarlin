...
$result=pg_prepare($dbconn,"normalwerte",'select * from handwerkstalente.talentwert where ID = $1');
...
$result=pg_prepare($dbconn,"mod",'select * from handwerkstalente.modifikation where ID = $1');
