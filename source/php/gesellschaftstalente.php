...
$result=pg_prepare($dbconn,"normalwerte",'select * from gesellschaftstalente.talentwert where ID = $1');
...
$result=pg_prepare($dbconn,"mod",'select * from gesellschaftstalente.modifikation where ID = $1');
